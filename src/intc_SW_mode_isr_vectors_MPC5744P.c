...
extern void spi0_rx_irq_handler(void);
extern void spi0_tx_irq_handler(void);

extern void spi1_rx_irq_handler(void);
extern void spi1_tx_irq_handler(void);

extern void spi2_rx_irq_handler(void);
extern void spi2_tx_irq_handler(void);

extern void PIT_timer0_irq_handler(void);
extern void PIT_timer1_irq_handler(void);
extern void PIT_timer2_irq_handler(void);
extern void PIT_timer3_irq_handler(void);

extern void can0_rx_isr_handler(void);
extern void can0_tx_isr_handler(void);
extern void can1_rx_isr_handler(void);
extern void can1_tx_isr_handler(void);
extern void can2_rx_isr_handler(void);
extern void can2_tx_isr_handler(void);

extern void can0_busoff_isr(void);
extern void can1_busoff_isr(void);
extern void can2_busoff_isr(void);

extern void eTimer0_ch0_irq(void);
extern void eTimer0_ch1_irq(void);
extern void eTimer0_ch2_irq(void);
extern void eTimer0_ch3_irq(void);
extern void eTimer0_ch4_irq(void);
extern void eTimer0_ch5_irq(void);

extern void eTimer1_ch0_irq(void);
extern void eTimer1_ch1_irq(void);
extern void eTimer1_ch2_irq(void);
extern void eTimer1_ch3_irq(void);
extern void eTimer1_ch4_irq(void);
extern void eTimer1_ch5_irq(void);

extern void eTimer2_ch0_irq(void);
extern void eTimer2_ch1_irq(void);
extern void eTimer2_ch2_irq(void);
extern void eTimer2_ch3_irq(void);
extern void eTimer2_ch4_irq(void);
extern void eTimer2_ch5_irq(void);
...
(uint32_t) &PIT_timer0_irq_handler, /* Vector # 226 Periodic Interrupt Timer (PIT_0) channel 0 PIT_0 */
(uint32_t) &PIT_timer1_irq_handler, /* Vector # 227 Periodic Interrupt Timer (PIT_0) channel 1 PIT_0 */
(uint32_t) &PIT_timer2_irq_handler, /* Vector # 228 Periodic Interrupt Timer (PIT_0) channel 2 PIT_0 */
(uint32_t) &PIT_timer3_irq_handler, /* Vector # 229 Periodic Interrupt Timer (PIT_0) channel 3 PIT_0 */
...
(uint32_t) &spi0_tx_irq_handler, /* Vector # 262 DSPI_SR[TCF] DSPI0 */
(uint32_t) &spi0_rx_irq_handler, /* Vector # 263 DSPI_SR[RFDF] DSPI0 */
...
(uint32_t) &spi1_tx_irq_handler, /* Vector # 271 DSPI_SR[TCF] DSPI1 */
(uint32_t) &spi1_rx_irq_handler, /* Vector # 272 DSPI_SR[RFDF] DSPI1 */
...
(uint32_t) &spi2_tx_irq_handler, /* Vector # 280 DSPI_SR[TCF] DSPI2 */
(uint32_t) &spi2_rx_irq_handler, /* Vector # 281 DSPI_SR[RFDF] DSPI2 */
...
(uint32_t) &adc0_irq_handler, /* Vector # 496 ADC_EOC ADC_0 */
...
(uint32_t) &adc1_irq_handler, /* Vector # 500 ADC_EOC ADC_1 */
...
(uint32_t) &can0_busoff_isr, /* Vector # 521 FLEXCAN_ESR_BOFF | FLEXCAN_Transmit_Warning | FLEXCAN_Receive_Warning FlexCAN_0 */
(uint32_t) &can0_rx_isr_handler, /* Vector # 522 FLEXCAN_BUF_00_03 FlexCAN_0 */
(uint32_t) &can0_rx_isr_handler, /* Vector # 523 FLEXCAN_BUF_04_07 FlexCAN_0 */
(uint32_t) &can0_rx_isr_handler, /* Vector # 524 FLEXCAN_BUF_08_11 FlexCAN_0 */
(uint32_t) &can0_rx_isr_handler, /* Vector # 525 FLEXCAN_BUF_12_15 FlexCAN_0 */
(uint32_t) &can0_rx_isr_handler, /* Vector # 526 FLEXCAN_BUF_16_31 FlexCAN_0 */
(uint32_t) &can0_tx_isr_handler, /* Vector # 527 FLEXCAN_BUF_32_39 FlexCAN_0 */
(uint32_t) &can0_tx_isr_handler, /* Vector # 528 FLEXCAN_BUF_40_47 FlexCAN_0 */
(uint32_t) &can0_tx_isr_handler, /* Vector # 529 FLEXCAN_BUF_48_55 FlexCAN_0 */
(uint32_t) &can0_tx_isr_handler, /* Vector # 530 FLEXCAN_BUF_56_63 FlexCAN_0 */
...
(uint32_t) &can1_busoff_isr, /* Vector # 534 FLEXCAN_ESR_BOFF | FLEXCAN_Transmit_Warning | FLEXCAN_Receive_Warning FlexCAN_1 */
(uint32_t) &can1_rx_isr_handler, /* Vector # 535 FLEXCAN_BUF_00_03 FlexCAN_1 */
(uint32_t) &can1_rx_isr_handler, /* Vector # 536 FLEXCAN_BUF_04_07 FlexCAN_1 */
(uint32_t) &can1_rx_isr_handler, /* Vector # 537 FLEXCAN_BUF_08_11 FlexCAN_1 */
(uint32_t) &can1_rx_isr_handler, /* Vector # 538 FLEXCAN_BUF_12_15 FlexCAN_1 */
(uint32_t) &can1_rx_isr_handler, /* Vector # 539 FLEXCAN_BUF_16_31 FlexCAN_1 */
(uint32_t) &can1_tx_isr_handler, /* Vector # 540 FLEXCAN_BUF_32_39 FlexCAN_1 */
(uint32_t) &can1_tx_isr_handler, /* Vector # 541 FLEXCAN_BUF_40_47 FlexCAN_1 */
(uint32_t) &can1_tx_isr_handler, /* Vector # 542 FLEXCAN_BUF_48_55 FlexCAN_1 */
(uint32_t) &can1_tx_isr_handler, /* Vector # 543 FLEXCAN_BUF_56_63 FlexCAN_1 */
...
(uint32_t) &can2_busoff_isr, /* Vector # 547 FLEXCAN_ESR_BOFF | FLEXCAN_Transmit_Warning | FLEXCAN_Receive_Warning FlexCAN_2 */
(uint32_t) &can2_rx_isr_handler, /* Vector # 548 FLEXCAN_BUF_00_03 FlexCAN_2 */
(uint32_t) &can2_rx_isr_handler, /* Vector # 549 FLEXCAN_BUF_04_07 FlexCAN_2 */
(uint32_t) &can2_rx_isr_handler, /* Vector # 550 FLEXCAN_BUF_08_11 FlexCAN_2 */
(uint32_t) &can2_rx_isr_handler, /* Vector # 551 FLEXCAN_BUF_12_15 FlexCAN_2 */
(uint32_t) &can2_rx_isr_handler, /* Vector # 552 FLEXCAN_BUF_16_31 FlexCAN_2 */
(uint32_t) &can2_tx_isr_handler, /* Vector # 553 FLEXCAN_BUF_32_39 FlexCAN_2 */
(uint32_t) &can2_tx_isr_handler, /* Vector # 554 FLEXCAN_BUF_40_47 FlexCAN_2 */
(uint32_t) &can2_tx_isr_handler, /* Vector # 555 FLEXCAN_BUF_48_55 FlexCAN_2 */
(uint32_t) &can2_tx_isr_handler, /* Vector # 556 FLEXCAN_BUF_56_63 FlexCAN_2 */
...
(uint32_t) &eTimer0_ch0_irq, /* Vector # 611 TC0IR eTimer_0 */
(uint32_t) &eTimer0_ch1_irq, /* Vector # 612 TC1IR eTimer_0 */
(uint32_t) &eTimer0_ch2_irq, /* Vector # 613 TC2IR eTimer_0 */
(uint32_t) &eTimer0_ch3_irq, /* Vector # 614 TC3IR eTimer_0 */
(uint32_t) &eTimer0_ch4_irq, /* Vector # 615 TC4IR eTimer_0 */
(uint32_t) &eTimer0_ch5_irq, /* Vector # 616 TC5IR eTimer_0 */
...
(uint32_t) &eTimer1_ch0_irq, /* Vector # 622 TC0IR eTimer_1 */
(uint32_t) &eTimer1_ch1_irq, /* Vector # 623 TC1IR eTimer_1 */
(uint32_t) &eTimer1_ch2_irq, /* Vector # 624 TC2IR eTimer_1 */
(uint32_t) &eTimer1_ch3_irq, /* Vector # 625 TC3IR eTimer_1 */
(uint32_t) &eTimer1_ch4_irq, /* Vector # 626 TC4IR eTimer_1 */
(uint32_t) &eTimer1_ch5_irq, /* Vector # 627 TC5IR eTimer_1 */
...
(uint32_t) &eTimer2_ch0_irq, /* Vector # 633 TC0IR eTimer_2 */
(uint32_t) &eTimer2_ch1_irq, /* Vector # 634 TC1IR eTimer_2 */
(uint32_t) &eTimer2_ch2_irq, /* Vector # 635 TC2IR eTimer_2 */
(uint32_t) &eTimer2_ch3_irq, /* Vector # 636 TC3IR eTimer_2 */
(uint32_t) &eTimer2_ch4_irq, /* Vector # 637 TC4IR eTimer_2 */
(uint32_t) &eTimer2_ch5_irq, /* Vector # 638 TC5IR eTimer_2 */
